...
const SHA256 = function (str) {
    ...
    function core_sha256(m, l) {
        var K = new Array(0x428A2F98, 0x71374491, 0xB5C0FBCF, 0xE9B5DBA5, 0x3956C25B, 0x59F111F1, 0x923F82A4, 0xAB1C5ED5, 0xD807AA98,
...
const generateSalt = function() {
    ...
    //Picks a random character and adds it to the salt until it reaches the desired size
    for (i = 0; i < size; i++) {
        newSalt += chars[Math.floor((Math.random() * length))];
    }
    return newSalt;
}
